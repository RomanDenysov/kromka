...
const TABS: { href: Route; label: string }[] = [
  { href: "/admin/system/settings", label: "Globálne nastavenia" },
  { href: "/admin/system/settings/configurations", label: "Konfigurácie" },
  { href: "/admin/system/settings/permissions", label: "Povolenia užívateľov" },
];

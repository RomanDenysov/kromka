...
export function OrderReadyEmail({
  ...
  return (
    <EmailLayout preview="Vaše lakocinky sú nachystané, príďte do Kromky!">
      <Section className="text-center">
        ...
        <Text className={EMAIL_PARAGRAPH_CLASS}>
          Tešíme sa na vašu návštevu. Objednávka na vás počká na našej predajni:
          <br />
          <Link
      ...
      <Section className={`${EMAIL_CARD_CLASS} mt-6 text-center`}>
        ...
        <Text className={EMAIL_MUTED_TEXT_CLASS}>
          Po vyzdvihnutí objednávky nám môžete dať vedieť, ako vám chutilo.
        </Text>
      </Section>
    </EmailLayout>
  );

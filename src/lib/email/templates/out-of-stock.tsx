...
export function OutOfStockEmail({
  ...
  return (
    <EmailLayout preview="Produkt momentálne nie je k dispozícii - Kromka">
      <Section className="text-center">
        ...
        <Text className={EMAIL_PARAGRAPH_CLASS}>
          Produkt &ldquo;{productName}&rdquo; aktuálne nie je k dispozícii.
          Robíme všetko preto, aby sme ho čím skôr naskladnili.
        </Text>
      </Section>
      ...
      <Section className={`${EMAIL_CARD_CLASS} mt-6 text-center`}>
        ...
        <Text className="text-base text-gray-800 italic">Vaša Kromka</Text>
      </Section>

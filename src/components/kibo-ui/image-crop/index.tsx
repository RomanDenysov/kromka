/** biome-ignore-all lint/style/noMagicNumbers: we will rewrite it latter */
"use client";
...
export const ImageCrop = ({
  ...
  const applyCrop = async () => {
    ...
    onCrop?.(await croppedImage.text());
  };
...
export const ImageCropContent = ({
  ...
  return (
    ...
    >
      {imgSrc && (
        // biome-ignore lint/correctness/useImageSize: we will rewrite it latter
        // biome-ignore lint/a11y/noNoninteractiveElementInteractions: we will rewrite it latter
        // biome-ignore lint/performance/noImgElement: we will rewrite it latter
        <img
          alt="crop"
          className="size-full"
          onLoad={onImageLoad}

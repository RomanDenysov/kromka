...
const gridItems: GridItemConfig[] = [
  ...
  // E-shop
  {
    ...
    href: "/e-shop?category=nase-pecivo" as Route,
  ...
  },
  {
    ...
    href: "/e-shop?category=maso-a-udeniny" as Route,

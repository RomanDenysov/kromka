...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          "^src/app/", // Next.js route files (page/layout/default/...) are framework entry points, discovered by convention not imports
        ],
      },
      to: {},
    },
    ...
    // --- Architecture boundaries (kromka) ---
    // Cross-feature composition through api/ and lib/ is intentional here
    // (orders -> cart/checkout/recipes, categories -> products, homepage ->
    // both), so there is deliberately NO "no-cross-feature" rule. What we DO
    // enforce is layering direction: dependencies point inward, never up.
    {
    ...
    },
    {
      ...
      comment:
        "Feature modules sit below the route layer and must not import runtime code " +
        "from src/app. Type-only imports (e.g. route param types like EshopParams) are " +
        "tolerated for now.",
      severity: "error",
      from: {
        path: "^src/features/",
...
// generated: dependency-cruiser@17.4.3 on 2026-06-15T18:38:25.936Z
